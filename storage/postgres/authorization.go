...
func (s *PostgresStorage) CreateAuthorization(userID, token string) *internal.Error {
	query := fmt.Sprintf(`
...
func (s *PostgresStorage) DeleteAuthorization(userID, token string) *internal.Error {
	query := fmt.Sprintf(`
