...
Feature: Search Default Products by Name
  ...
  Scenario: OK - Beginning of the name
    ...
    And "$.data[0].id" is a non empty string
    And "$.data[0].name" is a string equal to "Lentille"
    And "$.data[0].category.name" is a string equal to "Epicerie"
  ...
  Scenario: OK - Middle of the name
    ...
    Then the status code is 200
    And "$.data[0].id" is a non empty string
    And "$.data[0].name" is a string equal to "Saucisse de Morteau"
    And "$.data[0].category.name" is a string equal to "Boucherie"
  ...
  Scenario: OK - Accentuated character
    ...
    Then the status code is 200
    And "$.data[0].id" is a non empty string
    And "$.data[0].name" is a string equal to "Saucisse de Montbéliard"
    And "$.data[0].category.name" is a string equal to "Boucherie"
